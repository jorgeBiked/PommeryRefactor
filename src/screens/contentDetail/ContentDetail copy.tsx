...
const ContentDetail = ({ route, navigation }) => {
    ...
    const _getTimestamp = () => {
        if (
            playbackInstance &&
            state.playbackInstanceDuration > 0
        ) {
            return `${_getMMSSFromMillis(this.state.playbackInstancePosition)} / ${_getMMSSFromMillis(state.playbackInstanceDuration)}`;
        }
        return "";
    }
...
// class ContentDetail1 extends React.Component<Props, State> {
...
//         //Alert.alert('_onPlaybackStatusUpdate1')
//         if (status.isLoaded) {
//             //Alert.alert('isLoaded')
//             if (status.didJustFinish === true && this.playbackInstance != null) {
//                 this.playbackInstance.stopAsync();
//             }
//             // Alert.alert('isLoaded2')
//             // Alert.alert('status', status.shouldPlay)
//             // this.setState({
//             //     playbackInstancePosition: status.positionMillis,
//             //     playbackInstanceDuration: status.durationMillis,
//             //     shouldPlay: status.shouldPlay,
